...
async def run_task(target, task_func: Callable, args: tuple, start_msg: str, filename: str, caption: str, reply_markup):
    ...
    # Устанавливаем флаг выполнения в context.user_data (если передан)
    # Здесь мы не имеем доступа к context, поэтому флаг устанавливается в вызывающих функциях.
...
# --- Главная функция ---
def main():
    # Увеличенные таймауты без отключения проверки SSL
